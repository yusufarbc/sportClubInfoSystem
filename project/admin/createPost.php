    ...
    <div class="row d-flex justify-content-center">
        <div class="col-md-6">
            ...
            <form action="includes/share.inc.php" method="post">
                    <div class="forms-inputs mb-4"> <span>Başlık</span> <input name="title" autocomplete="on" type="text" class="w-100"> </div>
                    <div class="forms-inputs mb-4"> <span>Resim</span> <input name="image" autocomplete="on" type="text" class="w-100"></div>
                    ...
                    <div class="forms-inputs mb-4"> <span>İçerik</span><textarea name="content" cols="60" rows="10"></textarea></div>
                    <div class="mb-4"> <button type="submit" name="submit" class="btn btn-dark w-100">İçerik Ekle</button></div>
            </form>
            </div>
        </div>
    </div>
